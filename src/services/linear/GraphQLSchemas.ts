...
export type DocumentContentHistoryType = {
  ...
  contentData: Scalars['JSON']['output'];
...
export type GitHubSyncRepoInput = {
  /** The full name of the repository. */
...
export type GitHubSyncSettingsInput = {
  /** Mapping of team to repository for syncing */
  repoMapping?: InputMaybe<Array<TeamRepoMappingInput>>;
  /** The names of the repositories connected for the GitHub integration */
  repos?: InputMaybe<Array<GitHubSyncRepoInput>>;
};
...
export type IntegrationSettingsInput = {
  ...
  gitHubSync?: InputMaybe<GitHubSyncSettingsInput>;
...
export type TriageResponsibility = Node & {
  ...
  manualSelection?: Maybe<Scalars['JSONObject']['output']>;
...
export type TriageResponsibilitySchedule = {
  ...
  integrationError?: InputMaybe<Scalars['String']['input']>;
  /** Reference to the integration's schedule when using an integration. */
  integrationScheduleId?: InputMaybe<Scalars['String']['input']>;
};
...
export type TriageResponsibilityScheduleEntry = {
  ...
  externalUserEmail?: InputMaybe<Scalars['String']['input']>;
